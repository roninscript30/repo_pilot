      ...
      <div className="w-full max-w-lg">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <img src="/icon.svg" alt="GitOS" className="h-8 w-8" />
            <span className="text-sm font-bold text-surface-900 dark:text-surface-100">GitOS</span>
          </div>
        ...
        {step === "welcome" ? (
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-surface-200 bg-surface-0 p-10 text-center shadow-card dark:border-surface-600 dark:bg-surface-50">
            ...
            <h1 className="text-2xl font-bold text-surface-900 dark:text-surface-100">Welcome to GitOS</h1>
        ...
        {step === "account" && account ? (
          <div className="rounded-2xl border border-surface-200 bg-surface-0 p-8 shadow-card dark:border-surface-600 dark:bg-surface-50">
            ...
            <p className="mt-1 text-sm text-surface-500">
              GitOS indexes repositories you can access — yours and your organization's.
            </p>
