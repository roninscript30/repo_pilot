  ...
  const items: CommandItem[] = [
      ...
      ? ([
          {
            ...
            onSelect: () => navigate(repoWorkspacePathForFullName(repo.fullName)),
          },
          {
            id: "repo-branches",
            label: "View Branches",
            ...
            onSelect: () => navigate(repoWorkspacePathForFullName(repo.fullName, "branches")),
          },
          {
            id: "repo-commits",
            ...
            onSelect: () => navigate(repoWorkspacePathForFullName(repo.fullName, "commits")),
          },
          {
            ...
            group: "Current repository",
            keywords: ["pr", "reviews"],
            onSelect: () => navigate(repoWorkspacePathForFullName(repo.fullName, "pulls")),
          },
          {
            id: "repo-issues",
            label: "View Issues",
            ...
            onSelect: () => navigate(repoWorkspacePathForFullName(repo.fullName, "issues")),
          },
          {
            id: "repo-releases",
            label: "View Releases",
            ...
            onSelect: () => navigate(repoWorkspacePathForFullName(repo.fullName, "releases")),
          },
          {
            id: "repo-new-issue",
            label: "Create Issue",
    ...
    ...(repositories.length > 0
      ? (repositories.slice(0, 10).map((repository) => ({
          ...
          onSelect: () => navigate(repoWorkspacePathForFullName(repository.fullName)),
        })) satisfies readonly CommandItem[])
      : []),
    {
