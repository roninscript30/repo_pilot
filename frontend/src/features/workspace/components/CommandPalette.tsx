...
import { useRepositories, useRepositoryOverview } from "@/features/repositories/hooks";
import { buildCommands } from "@/features/workspace/services/commands";
  ...
  const items = useMemo(
    () =>
      buildCommands({
        ...
        startNewIssue: () => {
          if (fullName) navigate(repoWorkspacePathForFullName(fullName, "issues"));
        },
