...
- Slice 4: Compare center + diff experience (structured hunks from Rust `structured_diff`/`git_diff_files`, unified/split/word DiffViewer modes, merge + rebase previews); then Slice 5: Branch explorer + interactive branch graph; Slice 6: PR + Issues workspaces; Slice 7: repo activity + persistent per-account tabs + repo sync sources.
